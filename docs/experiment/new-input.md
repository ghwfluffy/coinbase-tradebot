Additional notes from the user:
  ...
  2026-01-04T00:06:00Z
    - Try to find patters of when losses are occurring. Example: if it were common that we are left holding the bag at the end of the stock market week, and if we sold at a slight loss before then it would help derisk those events
